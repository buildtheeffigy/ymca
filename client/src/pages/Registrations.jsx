...
{/*page for admin to view who is registered in what*/}
const Registrations = () => {
    ...
    const handleQuery = () =>{
      ...
      const results = programs.filter(post => {//Filter by first name
      ...
      .filter(post => {//Filter by week day
        ...
        <table>
            ...
            {state.list.map(programs=>(
                <tr key={programs.id}>
                    ...
                    <td>{programs.name}</td>
                    <td>
                      {programs.day_of_week.includes('1') ? <span>M </span>:<span></span>}
                      ...
                      {programs.day_of_week.includes('7') ? <span>Su </span>:<span></span>}
                    </td>
